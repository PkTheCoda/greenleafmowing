...
import logo from '../assets/greenleaflogodark.png'

const Footer = () => {
  return (
    <div className="bg-[#111111] font-merri">
            <div class="px-4 pt-16 mx-auto max-w-[95rem] md:px-24 lg:px-8">
                <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="mt-6 lg:max-w-sm">
                        <p class="text-sm text-white">
                            Greenleafmowing is the ultimate lawncare service catering to Richmond and the Greater Richmond area.
                        </p>
                        <p class="mt-4 text-sm text-white">
                            We specialize in everything from landscaping to garden decor to monthly/annual trimmings. The choice is up to you!
                        </p>
                    </div>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <a href="mailto:info@greenleafmowing@gmail.com" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-white">greenleafmowing@gmail.com</a>
                    </div>
                    <div class="flex">
                        <p class="mr-1 text-white">Address:</p>
                        <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300 text-white">
                    ...
                    <p class="mt-4 text-sm text-white">
                       No socials yet, soon to come!
                    </p>
                    </div>
                </div>
                <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    <p class="text-sm text-white">
                    © Copyright 2024 Greenleafmowing Inc. All rights reserved.
                    </p>
